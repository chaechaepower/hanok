  ...
  return (
    <form className={combinedClassName} onSubmit={handleSubmit}>
      <input
        ...
        disabled={disabled}
        maxLength={maxLength}
        className="peer h-full w-full rounded-(--nav-btn-radius) border border-warm/6 bg-warm/3 pl-4 pr-11 text-body-md text-neutral-100 placeholder:text-neutral-600 outline-none transition-all duration-250 focus:border-primary/40 focus:bg-warm/5 focus:shadow-primary-glow disabled:cursor-not-allowed disabled:opacity-60"
      />
      <button
        type="submit"
        aria-label="Search"
