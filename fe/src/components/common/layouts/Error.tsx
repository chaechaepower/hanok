  ...
  return (
    <div className="flex min-h-[70vh] w-full flex-col items-center justify-center gap-10 px-5 text-center">
      <div className="flex max-w-md flex-col items-center gap-4 whitespace-pre-line">
        <h1 className="text-2xl font-bold text-point">{message.title}</h1>
        <p className="text-sm leading-6 text-gold">{message.description}</p>
      </div>
      ...
      <button
        ...
        className="w-full max-w-xs rounded-xl border border-zinc-300 bg-point px-5 py-3 text-sm font-semibold text-background shadow-sm transition hover:bg-zinc-50 active:scale-[0.99]"
      >
