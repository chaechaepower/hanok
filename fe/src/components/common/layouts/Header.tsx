    ...
    <nav className="fixed left-0 right-0 top-0 z-[1000] flex h-16 items-center gap-4 border-b border-white/5 bg-background/94 backdrop-blur-[20px]">
      ...
      <div className="flex shrink-0 items-center gap-2 pr-6">
        <button
          ...
          className="flex h-(--nav-btn-height) items-center gap-1.5 whitespace-nowrap rounded-(--nav-btn-radius) border border-primary/35 bg-primary/15 px-3.5 text-subtitle-sm text-primary-light transition-all hover:border-primary/50 hover:bg-primary/25 hover:text-neutral-100"
        >
