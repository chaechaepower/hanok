  ...
  return (
    <>
      ...
      >
        ...
        <div ref={listRef} className="custom-scrollbar max-h-80 overflow-y-auto">
          {notifications.length === 0 ? (
          ...
          {hasNextPage && notifications.length > 0 && <div ref={triggerRef} className="h-4 w-full" aria-hidden />}
