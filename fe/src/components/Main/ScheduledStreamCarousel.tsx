      ...
      {streams.length > 0 ? (
        <>
          <button
            ...
            className="absolute left-3 top-[calc(50%+20px)] z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-primary-dark/30 bg-surface-elevated text-warm shadow-[0_14px_30px_rgba(0,0,0,0.18)] transition hover:bg-primary-muted"
          ...
          <button
            ...
            className="absolute right-3 top-[calc(50%+20px)] z-20 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full border border-primary-dark/30 bg-surface-elevated text-warm shadow-[0_14px_30px_rgba(0,0,0,0.18)] transition hover:bg-primary-muted"
