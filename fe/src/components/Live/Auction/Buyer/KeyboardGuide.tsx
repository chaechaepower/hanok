      ...
      <div className="flex items-stretch gap-4 px-4 py-3">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="mt-0.5 flex w-full gap-1">
            ...
            <span className="flex h-auto items-center justify-center px-1 text-[10px] text-[#a1a1aa]">입찰</span>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center gap-3 text-[11px] text-[#a1a1aa]">
          <div className="flex items-center gap-2">
            <span className="inline-flex h-7 items-center justify-center rounded bg-[#27272a] px-2 text-[10px] font-bold text-white">
              Tab
            </span>
            <span>탭 전환</span>
          </div>
          <div className="flex items-center gap-2">
            <span className="inline-flex h-7 w-7 items-center justify-center rounded bg-[#27272a] text-[10px] font-bold text-white">
              ↑
            </span>
            <span className="inline-flex h-7 w-7 items-center justify-center rounded bg-[#27272a] text-[10px] font-bold text-white">
              ↓
