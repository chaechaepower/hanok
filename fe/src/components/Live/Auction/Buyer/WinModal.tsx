        ...
        <div className="flex flex-col gap-4 px-7 py-6">
          <div className="flex items-center justify-between gap-4 rounded-[20px] border border-white/6 bg-white/3 px-4.5 py-5">
            ...
            <div className="flex shrink-0 flex-col items-end gap-2">
              <span className="text-[10px] text-neutral-500">낙찰가</span>
              <span className="text-[22px] font-black text-point">{finalPrice.toLocaleString('ko-KR')}원</span>
            </div>
          </div>

          <div className="flex flex-col gap-2">
            <p className="text-[11px] font-extrabold uppercase text-neutral-400">배송지 정보</p>
            <div className="rounded-2xl border border-white/7 bg-white/[0.02] px-4 py-3.5">
              ...
              <p className="mt-1.5 break-keep text-[11px] text-neutral-400">{address.phone}</p>
              <p className="mt-1.5 break-keep text-[11px] text-neutral-400">
          ...
          <p className="text-center text-[10px] leading-[1.7] text-neutral-600">
