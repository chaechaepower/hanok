    ...
    <div className="border-t border-white/6 pt-4">
      <div className="flex items-center justify-between">
        ...
        <div className="text-sm font-bold text-white">
          <span className="tabular-nums font-black">{formatPrice(auctionStatistics?.startPrice ?? 0, { suffix: false })}</span>
          원
        </div>
      </div>
      <div className="mt-2 flex items-center justify-between">
        ...
        <div className="text-xl font-black text-gold">
          <span className="tabular-nums font-black">{formatPrice(auctionStatistics?.currentPrice ?? 0, { suffix: false })}</span>
          원
        </div>
      </div>
    </div>
